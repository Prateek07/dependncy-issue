...
privateEndpointVariables = {
  ...
  va-avd-pe-func-prod-1 = {
    name                = "pe-avd-func-automation-usgovva-p01"
    resource_group_name = "rg-avd-automation-usgovva-p01"
    location            = "usgovvirginia"
    subnet_key          = "va-avd-snet-prod-3"
    subresource_names   = ["sites"]
    target_type         = "functionapp"
    target_key          = "va-avd-fa-prod-1"
  }
}
...
serviceBusQueueVariables = {
  ...
  va-avd-sbq-prod-2 = {
    name                                 = "sbq-avd-vmat-automation-usgovva-p01"
    namespace_key                        = "va-avd-sbm-prod-1"
    max_delivery_count                   = 5
    default_message_ttl                  = "P14D"
    dead_lettering_on_message_expiration = true
...
eventGridSystemTopicVariables = {
  va-avd-egst-prod-1 = {
    name                      = "egst-avd-vmat-automation-usgovva-p01"
    resource_group_name       = "rg-avd-automation-usgovva-p01"
    location                  = "usgovvirginia"
    source_storage_account_key = "va-avd-sa-prod-1"
    topic_type                = "Microsoft.Storage.StorageAccounts"
    identity_key              = "va-avd-mi-prod-1"
    log_analytics_workspace_key = "va-avd-law-prod-1"
    tags                      = {}
  }
}
    ...
    advanced_filter = {
      ...
      string_begins_with = [{ 
         key = "data.resourceInfo.id"        
          values = ["/subscriptions/368a2d81-e3d2-4772-b1f6-0ebc38a67125/resourceGroups/rg-avd-vm100-usgovva-p01/"]
      }]
    }  
  }
  va-avd-egs-prod-2 = {
    name                  = "egs-avd-vmat-automation-usgovva-p01"
    resource_group_name   = "rg-avd-automation-usgovva-p01"
    system_topic          = "egst-avd-vmat-automation-usgovva-p01"
    service_bus_queue_key = "va-avd-sbq-prod-2"
    delivery_identity_key = "va-avd-mi-prod-1"
...
appServicePlanVariables = {
  va-avd-asp-prod-1 = {
    name                = "asp-avd-automation-usgovva-p01"
    resource_group_name = "rg-avd-automation-usgovva-p01"
    location            = "usgovvirginia"
    os_type             = "Windows"
    sku_name            = "EP1"
...
windowsFunctionAppVariables = {
  va-avd-fa-prod-1 = {
    name                          = "func-avd-automation-usgovva-p01"
    resource_group_name           = "rg-avd-automation-usgovva-p01"
    location                      = "usgovvirginia"
    app_service_plan_key          = "va-avd-asp-prod-1"
    storage_account_key           = "va-avd-sa-prod-1"
    managed_identity_key          = "va-avd-mi-prod-1"
    service_bus_namespace_key     = "va-avd-sbm-prod-1"
    service_bus_queue_key         = "va-avd-sbq-prod-1"
    application_insights_resource_key = "va-avd-appi-prod-1"
    ...
    content_share_name              = "func-avd-automation-usgovva-p01"
    ...
    app_settings = {
      ...
      WEBSITE_CONTENTSHARE = "func-avd-automation-usgovva-p01"
      ...
      SERVICEBUS_QUEUE_NAME = "sbq-avd-vmlc-automation-usgovva-p01"
      TAG_ASSIGNMENT_QUEUE_NAME = "sbq-avd-vmat-automation-usgovva-p01"
      INPUT_CSV_BLOB = "avd-vm-master.csv"
      STATUS_CSV_BLOB = "state/avd-vm-processing-status.csv"
      STORAGE_ACCOUNT_NAME = "stavdfausgovvap01"
      STORAGE_CONTAINER_NAME = "avd-vmat-automation"
      AUTOMATION_REGION = "usgovvirginia"
    }
      tags = {}
      log_analytics_workspace_key = "va-avd-law-prod-1"
  }
