#tf.vars file for AVD environment in US Gov Arizona regions
rgVariables = {
  az-avd-rg-prod-1 = {
...
snetVariables = {
  ...
  vnetrg            = "rg-network-infra-prod"
  vnetname          = "vnet-avd-prod-usgovarizona"
  snetName          = "snet-avd-functionapp-usgovaz-p01"
  snetAddressPrefix = ["10.248.248.64/27"]
...
nsgVariables = {
  ...
  az-avd-nsg-prod-4 = {
    name                = "nsg-avd-functionapp-usgovaz-p01"
    resource_group_name = "rg-network-infra-prod"
    location            = "usgovarizona"
    security_rules = []
  }
}
############################ Network Security Group to Subnet Association variables ############################
nsgSubnetAssociations = {
  ...
  az-avd-nsgassoc-prod-4 = {
    nsg_key    = "az-avd-nsg-prod-4"
...
applicationGroupVariables = {
  az-avd-ag-prod-1 = {
    name                         = "app-avd-vm100-usgovaz-p01-pr01"
    resource_group_name          = "rg-avd-vm100-usgovaz-p01"
    location                     = "usgovarizona"
...
############################# Workspace to Application Group Association Variables ############################
...
################################ Azure Compute Gallery Image Definition Variables ############################
...
sessionHostVariables = {
  ...
  az-avd-sh-prod-2= {
    hostpool_key         = "az-avd-hp-prod-1"
    prefix               = "EWV0210001"                 #Prefix needs to be updated as per the requirements
    start_index          = 1
    ...
    resource_group_name  = "rg-avd-vm100-usgovaz-p01"
    subnet_key           = "az-avd-snet-prod-1"
    vm_size              = "Standard_NV36ads_A10_v5"        #SKU needs to be Updated as per the requirements
    admin_username       = "etn-avd-sessionhost-uname"
    admin_password       = "etn-avd-sessionhost-pass"
    domain_join_username = "etn-avd-domainjoin-uname"
    domain_join_password = "etn-avd-domainjoin-pass"
    ...
    ou_path              = "OU=Computers,OU=Enterprise Clients-AVDI,DC=FED,DC=etnfederal,DC=com"
    gallery_image_version_key = "az-avd-img-ver-prod-2"
    disk_size_gb              = 1024                          #Disk size needs to be updated as per the requirements
    enable_nvidia_gpu_driver = true
    vtpm_enabled = true
    secure_boot_enabled = true
    tags = {
  ...
  az-avd-sh-prod-3= {
    hostpool_key         = "az-avd-hp-prod-1"
    prefix               = "testrgvm"                 #Prefix needs to be updated as per the requirements
    start_index          = 1
    ...
    resource_group_name  = "rg-avd-vm100-usgovaz-p01"
    subnet_key           = "az-avd-snet-prod-1"
    vm_size              = "Standard_D4s_v5"        #SKU needs to be Updated as per the requirements
    admin_username       = "etn-avd-sessionhost-uname"
    admin_password       = "etn-avd-sessionhost-pass"
    domain_join_username = "etn-avd-domainjoin-uname"
    domain_join_password = "etn-avd-domainjoin-pass"
...
serviceBusQueueVariables = {
  az-avd-sbq-prod-1 = {
    name                                 = "sbq-avd-vmlc-automation-usgovaz-p01"
  ...
  az-avd-sbq-prod-2 = {
    name                                 = "sbq-avd-vmat-automation-usgovaz-p01"
    namespace_key                        = "az-avd-sbm-prod-1"
    max_delivery_count                   = 5
    default_message_ttl                  = "P14D"
    dead_lettering_on_message_expiration = true
...
eventGridSystemTopicVariables = {
  az-avd-egst-prod-1 = {
    ...
    virginia_identity_name    = "uami-avd-automation-usgovva-p01"
    virginia_identity_resource_group_name = "rg-avd-automation-usgovva-p01"
    log_analytics_workspace_key = "az-avd-law-prod-1"
    tags                      = {}
  }
  az-avd-egst-prod-2 = {
...
eventGridSubscriptionVariables = {
  az-avd-egs-prod-1 = {
    name                  = "egs-avd-vmlc-automation-usgovaz-p01"
    resource_group_name   = "rg-avd-automation-usgovaz-p01"
    ...
    resource_group_filter_names = ["rg-avd-vm100-usgovaz-p01"]
    advanced_filter = {
      string_in = [
        {
      ...
      #   values = ["/subscriptions/368a2d81-e3d2-4772-b1f6-0ebc38a67125/resourceGroups/rg-avd-vm100-usgovaz-p01/"]
      # }]
    }  
  }
  az-avd-egs-prod-2 = {
    name                  = "egs-avd-vmat-automation-usgovaz-p01"
    resource_group_name   = "rg-avd-automation-usgovaz-p01"
    system_topic          = "egst-avd-vmat-automation-usgovaz-p01"
    service_bus_queue_key = "az-avd-sbq-prod-2"
    delivery_identity_key = "az-avd-mi-prod-1"
    ...
    advanced_filter = {
      string_in = [
        {
          key   = "subject"
          values = ["/blobServices/default/containers/avd-vmat-automation/blobs/avd-vm-master.csv"]
        }
      ]
    } 
    # subject_filter = {
    #   subject_begins_with = "/blobServices/default/containers/avd-vmat-automation/blobs/"
    #   subject_ends_with   = "avd-vm-master.csv"
