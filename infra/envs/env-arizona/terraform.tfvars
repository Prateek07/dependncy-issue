...
eventGridSystemTopicVariables = {
  az-avd-egst-prod-1 = {
    ...
    virginia_identity_resource_group_name = "rg-avd-automation-usgovaz-p01"
    tags                      = {}
  }
  az-avd-egst-prod-2 = {
      ...
      string_in = [
        {
          ...
          values = [
            "/blobServices/default/containers/avd-vmat-automation/blobs/avd-vm-master.csv"
          ]
        }
      ]
    }
...
windowsFunctionAppVariables = {
  az-avd-fa-prod-1 = {
    ...
    app_settings = {
      ...
      //ALLOWED_VM_PREFIXES = "EWV0010001"
