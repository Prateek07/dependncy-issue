...
function Initialize-Settings {
    Write-LogInfo "Initializing vm-entra-delete settings."
...
try {
    ...
    Write-LogInfo "============================================================"
    Write-LogInfo "vm-entra-delete Service Bus trigger fired."
    ...
    Write-LogInfo "vm-entra-delete function completed successfully. ServiceBusMessageId='$messageId'."
}
catch {
