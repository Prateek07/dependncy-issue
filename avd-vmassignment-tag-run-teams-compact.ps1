...
function Send-TagAssignmentSummaryTeamsNotification {
    ...
    $bodyElements.Add(@{
        ...
        spacing   = "Medium"
        columns   = @(
            @{ type = "Column"; width = "1.0"; items = @(@{ type = "TextBlock"; text = "VM";            weight = "Bolder"; wrap = $true }) },
            @{ type = "Column"; width = "2.3"; items = @(@{ type = "TextBlock"; text = "Assigned user"; weight = "Bolder"; wrap = $true }) },
            @{ type = "Column"; width = "1.0"; items = @(@{ type = "TextBlock"; text = "Cost center";   weight = "Bolder"; wrap = $true }) },
            @{ type = "Column"; width = "1.0"; items = @(@{ type = "TextBlock"; text = "Status";        weight = "Bolder"; wrap = $true }) }
        )
    })
    ...
    foreach ($item in $summaryRows) {
        ...
        $bodyElements.Add(@{
            ...
            spacing   = "Small"
            columns   = @(
                @{ type = "Column"; width = "1.0"; items = @(@{ type = "TextBlock"; text = $vmName;       wrap = $true }) },
                @{ type = "Column"; width = "2.3"; items = @(@{ type = "TextBlock"; text = $assignedUser; wrap = $true }) },
                @{ type = "Column"; width = "1.0"; items = @(@{ type = "TextBlock"; text = $costCenter;  wrap = $true }) },
                @{ type = "Column"; width = "1.0"; items = @(@{ type = "TextBlock"; text = $status; color = $statusColor; weight = "Bolder"; wrap = $true }) }
            )
        })
